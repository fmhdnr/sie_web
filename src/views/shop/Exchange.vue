  ...
  <div class="body">
    ...
    <el-row>
      <el-col :span="12" :offset="6">
        <div style="text-align: center;font-weight: bold;font-size: 30px" >All Merchandise Exchange</div>
      </el-col>
      ...
      <el-col :span="5" v-for="(item,index) of merchList" :key="index"  :offset="index%4==0?0:1">
        <el-card :body-style="{ padding: '0px' }" style="width: 300px;margin-bottom: 20px">
          ...
          <el-row style="width:100%;height: 100%;">
            ...
            <el-col :span="12" :offset="6">
              <el-button style="color:royalblue;" icon="el-icon-goods" type="primary" @click="exchange()">
                Exchange
              </el-button>
            </el-col>
          </el-row>
...
<script>
import {exchange} from '@/api/buy.js'
export default {
  data() {
    return {
      merchList:[],
  ...
  methods: {
    ...
    exchange(){
      this.$alert("You have submitted an exchange application.",'Notice',{
        confirmButtonText:"Confirm",
      });
    }
